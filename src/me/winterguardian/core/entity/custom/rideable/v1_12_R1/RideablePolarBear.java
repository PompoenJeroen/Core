...
public class RideablePolarBear extends EntityPolarBear implements RideableEntity
{
	private float climbHeight, jumpHeight, jumpThrust, speed, backwardSpeed, sidewaySpeed, acceleration;

	public RideablePolarBear(org.bukkit.World world)
	{
		this(((CraftWorld)world).getHandle());
	}

	public RideablePolarBear(World world)
	{
		super(world);
		this.climbHeight = 1f;
		this.jumpHeight = 1f;
